...
### 自由模式：对比和话题分流
- 如果用户点击 Tag 或自由提问里包含“前几天、昨天、不同、变化、对比、最近几天”，本轮必须先回答“不同在哪里”。不要只描述今天；如果历史数据不足 2 天，明确说“现在不能硬比较”。
...
### 自由模式：对比和话题分流
- 如果用户点击 Tag 或自由提问里包含“前几天、昨天、不同、变化、对比、最近几天”，本轮必须先回答“不同在哪里”。周视图要优先做跨天比较；如果数据不足，明确说不能硬比较。
