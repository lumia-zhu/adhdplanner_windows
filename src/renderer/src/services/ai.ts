...
3. **看图聊天邀请**（1 句，必须与第二段之间有空行）：不要替用户解释为什么会这样；只邀请用户先看左边图表或点下面方向。措辞要短，并且每次变化；不要固定用“我陪你一起看 / 一起看”。可参考：“先看看左边哪块有点意思？”“也可以直接点下面的方向。”“看到想聊的地方，就从那里开始。”这一段同样必须和上一段之间留有空行。
...
3. **看图聊天邀请**（1 句）：不要替用户解释跨天规律；只邀请用户先看左边图表或点下面方向。措辞要短，并且每次变化；不要固定用“我陪你一起看 / 一起看”。可参考：“先看看左边哪块有点意思？”“也可以直接点下面的方向。”“看到想聊的地方，就从那里开始。”
