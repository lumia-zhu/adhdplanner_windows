...
| 情绪 × 行为观察类 | 只在有心情记录、用户主动提到状态，或当前主线涉及开始困难/卡顿/节奏变化时使用。情绪是一天粒度，必须结合前几天或本周不同天对比。 | 今天状态和前几天哪里不一样？状态低的天卡在哪里？情绪变化和任务节奏有关吗？哪些天状态和完成度不一致？ |
...
| 情绪 × 行为观察类 | 今天状态和前几天哪里不一样？<br>今天心情下哪些事更容易开始？<br>今天状态下卡点有什么不同？<br>心情变化和节奏有关吗？<br>状态不同时任务怎么变了？<br>哪些心情下更容易动起来？<br>状态低的天卡在哪里？<br>心情好的天做法有什么不同？<br>情绪变化和任务节奏有关吗？<br>哪些天状态和完成度不一致？ |
